				...
				<div class="row">
					<div class="col-sm-9">
						<div class="panel panel-default" id="cart-panel"
							...
							<div class="panel-heading" style="background-color: white;">
								<span>Items in your wishlist</span> <span style="float: right">(<strong>2</strong>)
									Items
								</span>
							</div>
								...
								<div class="row">
									<div class="col-sm-3">
										<div style="border: 1px solid">
											<img alt=""
												src="https://product.koovs.com/232x293/152340_55ab9b66a69146d68b5cd98896bdde26_image1_super_zoom.jpg">
										</div>
									</div>
									<div class="col-sm-5">
										<h3 style="padding-bottom: 10px;">
											<a href="${pageContext.request.contextPath}/products/product" class="text-navy"><font color="#1ab39"
												style="font-size: 20px;">Desktop publishing software
											</a></font>
										</h3>
										<p class="small" style="padding-bottom: 10px;">It is a
											long established fact that a reader will be distracted by the
											readable content of a page when looking at its layout. The
											point of using Lorem Ipsum is</p>
										<dl class="small m-b-none" style="padding-bottom: 10px;">
											<dt>Description lists</dt>
											<dd>A description list is perfect for defining terms.</dd>
										</dl>
										<div class="m-t-sm">
											<a href="#" class="text-muted" style="color: green"><i
												class="fa fa-plus"></i> Add to cart </a> | <a href="#"
												class="text-muted" style="color: red"><i
												class="fa fa-trash"></i> Remove from wishlist</a>
										</div>
									</div>
									<div class="col-sm-2">
										<input class="form-control" type="number" value="1">
									</div>
									<div class="col-sm-2">$ 1800</div>
								</div>
								<hr>
								<div class="row">
									<div class="col-sm-3">
										<div style="border: 1px solid">
											<img alt=""
												src="https://product.koovs.com/300x400/144335_c3d70d14c9394d4f8b4982d443b44c1c_image1_super_zoom.webp">
										</div>
									</div>
									<div class="col-sm-5">
										<h3 style="padding-bottom: 10px;">
							...
							<div class="panel-footer" style="background-color: white;">
								<div class="row">
									<div class="col-sm-4">
										<button class="btn btn-white" style="width: 160px;">
									...
									<div class="col-sm-3">
										<button class="btn btn-primary float-right"
											style="background-color: #1ab394; width: 160px;">
					...
					<div class="col-sm-3">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								...
								<h2 style="color: brown">$ 3600</h2>
							</div>
							<div class="panel-footer" style="background-color: white">
								<div class="btn-group">
									<a href="#" class="btn btn-primary btn-sm"><i
										class="fa fa-shopping-cart"></i>Add to cart</a> <a href="#"
										class="btn btn-white btn-sm" style="background-color: darkgray">
					...
					<div class="col-sm-3">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<h3 style="padding-bottom: 10px; font-size: 20px;">
									<strong>+91 8892042721</strong>
								</h3>
								<p>Please contact with us if you have any questions. We are
									avalible 24h.</p>
							</div>
						</div>
					</div>
