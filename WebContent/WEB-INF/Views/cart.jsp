					...
					<div class="col-sm-9">
						<div class="panel panel-default" id="cart-panel"
							...
							<div class="panel-heading" style="background-color: white;">
								<span>Items in your cart</span> <span style="float: right">(<strong>2</strong>)
									Items
								</span>
							</div>
								...
								<div class="row">
									...
									<div class="col-sm-5">
										<h3 style="padding-bottom: 10px;">
											<a href="#" class="text-navy"><font color="#1ab39"
										...
										<div class="m-t-sm">
											<a href="#" class="text-muted" style="color: red"><i
							...
							<div class="panel-footer" style="background-color: white">
								<div class="btn-group">
									<a href="#" class="btn btn-primary btn-sm"><i
										...
										class="btn btn-white btn-sm" style="background-color: red">
										Cancel</a>
								</div>
							</div>
						</div>
