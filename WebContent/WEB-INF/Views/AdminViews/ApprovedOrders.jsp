<div class="container">
	<h5>
		<a>Orders / <font color="orange">Approved Orders</font></a>
	</h5>
	<div class="row">
		<div class='col-md-12'>
...
var getPendingOrders = async function(){
	...
	for(key in response){
		...
		if(order.shippingStatus == 1) map[key] = order; 
	}
	appendPendingOrders(map);
}

var approvePendingOrder = async function(orderCode){
	var param = "orderCode="+orderCode+"&status="+"SHIP";
						            ...
						            "<div class='panel-heading' role='tab' id='headingOne8"+key+"'>"+
						                "<h4 class='panel-title'>"+
						                    "<a style='border-radius: 0px;' role='button' data-toggle='collapse' data-parent='#accordion8' href='#collapseOne8"+key+"' aria-expanded='true' aria-controls='collapseOne8"+key+"'>"+
						                        ...
						                        "<div class='row' style='margin-top: 10px;'>"+
						                            "<div class='col-sm-12'>"+
						                                "<button class='btn btn-warning' style='float: right' onclick='approvePendingOrder("+key+")'>Ship Order</button>"+
						                            "</div>"+
						                        "</div>"+
						                    "</a>"+
						                "</h4>"+
